(function($) {
  $.fn.tweet = function(o){
    var s = $.extend({
      ...
      template: "{time}{text}{reply_action}{favorite_action}",   // [string or function] template used to construct each tweet <li> - see code for available vars
    ...
    function extract_template_data(item){
      ...
      o.avatar = o.avatar_size ?
        t('<a class="tweet_avatar" href="{user_url}"><img alt="" src="{avatar_url}" height="{avatar_size}" width="{avatar_size}" alt="{screen_name}\'s avatar" title="{screen_name}\'s avatar" border="0"/></a>', o) : '';
