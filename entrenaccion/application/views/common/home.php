...
<ul id="menu" class="list-inline">
    ...
    <li><a href="/sistema/caja"><img src=<?php echo "\"".base_url() ."img/cash.png\"";?> class="img-rounded"></a>Caja</li>
    ...
    <li><a href="/sistema/promociones"><img src=<?php echo "\"".base_url() ."img/admin.png\"";?> class="img-rounded"></a>Administración</li>
</ul>
</div>
