          ...
          <li><a href="/sistema/logout"><i class="fa fa-sign-out"></i>Logout</a></li>
            ...
            <aside class="sidebar">
                    <ul class="nav nav-stacked">
                        ...
                        <li><a id="btn_his_pag" >Ver Historial de pagos</a></li>
                        <li><a id="btn_cor_caj" >Realizar corte de caja</a></li>
                    </ul>
                </aside>
 ...
 <div class="container">
    ...
    <div class="row clearfix">
      <div class="span12">
       ...
       <div id="pago">
        <div class="span10">
          <form id="f_matricula_enrolador" class="form-horizontal"  method="post" action="#" >
            <fieldset>
